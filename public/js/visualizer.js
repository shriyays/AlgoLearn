...
class VisualizerApp {
  ...
  async init() {
    ...
    this.controls = new PlaybackControls(
      this.renderer,
      (comparisons, swaps, time, step, total) => {
  ...
  displayComplexity() {
    ...
    document.getElementById("spaceComplexity").textContent =
      this.algorithm.spaceComplexity;
  }

  setupArrayControls() {
    document
      .getElementById("randomArrayBtn")
      .addEventListener("click", () => this.generateRandomArray());
    document
      .getElementById("reversedArrayBtn")
      .addEventListener("click", () => this.generateReversedArray());
    document
      .getElementById("nearlySortedBtn")
      .addEventListener("click", () => this.generateNearlySortedArray());
  ...
  generateNearlySortedArray() {
    ...
    for (let i = 0; i < swapCount; i++) {
      ...
      [this.currentArray[idx1], this.currentArray[idx2]] = [
        this.currentArray[idx2],
        this.currentArray[idx1],
      ];
    }
    this.runAlgorithm();
  }
